...
description: Master production RAG, AI agents, and LLM evaluations. Focus on reliability, cost-optimization, and safety. Use PROACTIVELY for AI feature implementation.
primary: agent
---
